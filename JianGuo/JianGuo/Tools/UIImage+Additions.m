...
CGFloat CDegreesToRadians(CGFloat degrees) {return degrees * M_PI / 180;};
CGFloat CRadiansToDegrees(CGFloat radians) {return radians * 180/M_PI;};
...
{
    return [self imageRotatedByDegrees:CRadiansToDegrees(radians)];
}
...
- (UIImage *)imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation(CDegreesToRadians(degrees));
    ...
    CGContextRotateCTM(bitmap, CDegreesToRadians(degrees));
