...
//        timestampLabel.textColor = [[LCCKSettingService sharedInstance] defaultThemeColorForKey:@"TableView-CellMinor"];// 原来 源代码
        
        timestampLabel.textColor = GreenColor;//自己工程需要改的代码
