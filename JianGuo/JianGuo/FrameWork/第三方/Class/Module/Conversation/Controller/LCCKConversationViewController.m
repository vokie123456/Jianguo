...
- (instancetype)initWithPeerId:(NSString *)peerId {
    ...
    [NotificationCenter addObserver:self selector:@selector(changeTitle:) name:kNotificationGotChatUserInfon object:nil];
...
-(void)changeTitle:(NSNotification *)noti
{
    if (_peerId) {
        ...
        LCCKConversationNavigationTitleView *titleView = (LCCKConversationNavigationTitleView *)self.navigationItem.titleView;
        titleView.conversationNameView.text = noti.object;
    }
}
