...
#define kTextSelectColor [UIColor colorWithRed:68/255.0 green:141/255.0 blue:224/255.0 alpha:1]
...
//设置筛选框头部title
-(void)configHeaderTitle:(NSString *)title row:(NSInteger)row
{
    _currentSelectRowArray[_currentSelectedMenudIndex] = @(row);
    CATextLayer *titleLayer = (CATextLayer *)_titles[_currentSelectedMenudIndex];
